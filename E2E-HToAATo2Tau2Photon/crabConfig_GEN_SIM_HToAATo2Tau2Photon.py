...
config.General.requestName = 'HToAATo2Tau2Photon_Hadronic_%s_pythia8_GEN_SIM_'%Mass_tag
...
config.Data.outputPrimaryDataset = 'GEN_SIM_HToAATo2Tau2Photon_%s_m3p6To8'%Mass_tag
...
config.Data.outLFNDirBase = '/store/group/lpcml/ereinhar/MCGeneration_run3'
