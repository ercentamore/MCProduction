...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-Run3Summer23BPixGS-00006-fragment_modified_To_H_AA_2Tau2Pho_hadronic.py nevts:10'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(        
            ...
            '36:new = a2 a2 1 0 0 2.0 0.0 0.0 2.54 0.0',
            '36:isResonance = on',
            '36:mayDecay = on',
            '36:onMode = on',
            ...
            '35:new = a1 a1 1 0 0 2.0 0.0 0.0 2.54 0.0',
            '35:isResonance = on',
            '35:mayDecay = on',
            '35:onMode = on',
            '35:addChannel = 1, 1.0, 101, 21, 21',
            '35:mWidth = 1e-3',
