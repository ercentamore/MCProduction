...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-Run3Summer23BPixGS-00006-fragment_modified_To_H_AA_2Photon2Tau_leptonic.py nevts:10'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(        
            ...
            '35:new = a1 a1 1 0 0 1.27 0.0 0.0 2.54 0.0',
			'35:isResonance = on',
			'35:mayDecay = on',
            '35:onMode = on',
