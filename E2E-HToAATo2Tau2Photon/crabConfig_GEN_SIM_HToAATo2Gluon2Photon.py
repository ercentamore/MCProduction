...
config.General.requestName = 'HToAATo2Gluon2Photon_Hadronic_%s_pythia8_GEN_SIM'%Mass_tag
...
config.JobType.psetName = 'GEN_SIM_HToAATo2Gluon2Photon_cfg.py'
...
config.Data.outLFNDirBase = '/eos/uscms/store/user/ecentamo/GEN_SIM'
