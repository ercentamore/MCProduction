...
inputFiles_ = open('/uscms/home/ecentamo/nobackup/CMSSW_13_0_13/src/MCProduction/E2E-HToAATo2Tau2Photon/AOD_file_list.txt').readlines()

#config.section_('General')
config.General.requestName = '%s_MiniAODSIM'%Mass_tag
...
config.JobType.psetName = 'MiniAOD_HToAATo2Gluon2Photon_cfg.py'
config.Data.outputPrimaryDataset = 'MiniAOD_HToAATo2Gluon2Photon_%s_m3p6To8'%Mass_tag
